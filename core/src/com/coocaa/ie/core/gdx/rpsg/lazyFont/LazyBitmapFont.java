package com.coocaa.ie.core.gdx.rpsg.lazyFont;
 ...
 */
public class LazyBitmapFont extends BitmapFont implements Serializable {
...
//        getRegion().getTexture().setFilter(Texture.TextureFilter.Linear, Texture.TextureFilter.Linear);
    ...
    public static class LazyBitmapFontData extends FreeTypeBitmapFontData {
        ...
        protected Glyph generateGlyph(char ch) {
            ...
            Pixmap map = gab.bitmap.getPixmap(Format.RGBA8888, font.getColor(), 1);
